    ...
    'panels' =>array (
        'LNK_NEW_CONTACT' => array (
            array (
                array (
                    'name' => 'first_name',
                    'customCode' => '{html_options name="Contactssalutation" options=$fields.salutation.options selected=$fields.salutation.value}&nbsp;<input name="Contactsfirst_name" id="Contactsfirst_name" size="25" maxlength="25" type="text" value="{$fields.first_name.value}">',
                ),
                'title',
            ), 
            array (
            ...
            array (
                array (
                    'name' => 'client_id_c',
                    'customCode'=>'
                    <input id="Contactsclient_id_c" name="Contactsclient_id_c" size="25" maxlength="25" type="text" value="{$fields.client_id_c.value}">
