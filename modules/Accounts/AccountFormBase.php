...
function handleSave($prefix,$redirect=true, $useRequired=false){	
	...
	// echo $_POST['website'].'<br><br>'; 
	// echo $_POST['Accounts0emailAddress0'].'<br><br>';
	// echo $_POST['id'].'<br><br>';
	// $id= $_POST['id'];
    // $name= $_POST['name']; 
    // $email= $_POST['Accounts0emailAddress0']; 
    // $phone =  $_POST['phone_office'];
    // $accountNo = "0127001818500";
    // echo $_POST['phone_fax'].'<br><br>';
    // echo $_POST['billing_address_street'].'<br><br>'; 
    // echo $_POST['billing_address_city'].'<br><br>';
    // echo $_POST['employees'].'<br><br>';
	
	//echo "http://192.168.1.225:8680/core/api/v1.0/account/$accountNo/balance<br><br>";
	
	//echo "http://localhost/APIs/api/$phone<br><br>";
	
	
	
//   $curl = curl_init();
//   curl_setopt_array($curl, array(
//   CURLOPT_URL => "http://192.168.1.8/APIs/insertAPI.php",
...
//   CURLOPT_POSTFIELDS => "name=$name&email=$email&password=$phone&undefined=",
//   CURLOPT_HTTPHEADER => array(
//     "Content-Type: application/x-www-form-urlencoded",
//     "Postman-Token: 170bf42f-df10-49fd-aa7d-73168451cbf2",
...
//   echo "cURL Error #:" . $err;
// } else {
//   $ress = json_decode($responses, true);
//   echo "<script>alert('".$ress['message']."')</script>";
//   //echo $responses;
//   }
// 	//die;
	// $curl = curl_init();
  // curl_setopt_array($curl, array(
  // CURLOPT_PORT => "8680",
  // CURLOPT_URL => "http://192.168.1.225:8680/core/api/v1.0/account/$accountNo/balance",
  // CURLOPT_RETURNTRANSFER => true,
  // CURLOPT_ENCODING => "",
  // CURLOPT_MAXREDIRS => 10,
  // CURLOPT_TIMEOUT => 30,
  ...
  // CURLOPT_HTTPHEADER => array(
    // "Content-Type: application/x-www-form-urlencoded",
    // "Postman-Token: 68b76211-71ec-4367-888f-0c1ea2f19812",
    // "cache-control: no-cache",
    // "x-api-key: 123456",
    // "x-api-secret: 7890"
  // ),
...
// curl_setopt_array($curl, array(
  // CURLOPT_URL => "http://localhost/APIs/api/$phone",
  // CURLOPT_RETURNTRANSFER => true,
  // CURLOPT_ENCODING => "",
  // CURLOPT_MAXREDIRS => 10,
  // CURLOPT_TIMEOUT => 30,
  ...
  // CURLOPT_POSTFIELDS => "",
  // CURLOPT_HTTPHEADER => array(
    // "Postman-Token: c363f26c-9e37-4c28-9c2a-ccc81af78ad9",
    // "cache-control: no-cache"
  // ),
// ));
...
// curl_setopt_array($curl, array(
  // CURLOPT_PORT => "8680",
  // CURLOPT_URL => "http://192.168.1.225:8680/core/api/v1.0/account/0127001818500/deposit",
  // CURLOPT_RETURNTRANSFER => true,
  // CURLOPT_ENCODING => "",
  // CURLOPT_MAXREDIRS => 10,
  // CURLOPT_TIMEOUT => 30,
  // CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
  // CURLOPT_CUSTOMREQUEST => "PUT",
  // CURLOPT_POSTFIELDS => "amount=200&documentRef=dsgh&narration=Some%20narration%20sdsd&postBy=Phi&customerTel=233200000000&transBy=Peter&postTerminal=Atm&undefined=",
  // CURLOPT_HTTPHEADER => array(
    // "Content-Type: application/x-www-form-urlencoded",
    // "Postman-Token: 61452a4e-047c-4d4f-a9c4-0118d2caa6a0",
    // "cache-control: no-cache",
    // "x-api-key: 123456",
    // "x-api-secret: 7890"
  // ),
