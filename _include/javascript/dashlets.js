...
$(document).ready(function(){
    ...
    $('iframe[title="Total Customers Per Segment"]').attr('src',document.location.protocol+'//'+window.location.hostname+'/gg/img/customer360/count-contacts.php?userid='+userid);

    $('iframe[title="Upcoming Birthdays"]').attr('src',window.location.protocol+'//'+window.location.hostname+'/gg/img/customer360/upcoming-birthdays.php?userid='+userid);
