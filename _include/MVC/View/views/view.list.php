...
class ViewList extends SugarView
{
    ...
    public function ViewList()
    {
        ...
        self::__construct();
       // print("<script>alert('Amos');</script>");
    }
    ...
    /*Sync Segments from core banking*/
    public function syunc_segments(){
    global $current_user;
    if($_REQUEST["module"]=="Accounts"){

     print("Only Segments  module");
    // echo $_REQUEST['current_query_by_page'];
    // print_r($this->bean);
         echo "<script>
  // alert('kkkk');
   ...
   $.ajax({
    type:'POST',
    url:'../gg/img/customer360/customer_segments.php?user_id=$current_user->id',
    ...
    /*::::::::::::End of segments sync::::::::::::*/

    /*:::::::::::Sync contacts from core banking::::::::::::: */
    public function sync_contacts(){
    global $current_user;
    if($_REQUEST["module"]=="Contacts"){

    echo "Contacts module only";
   ...
   /* End of customer/contacts sync*/

   /* This code/function is for AOS_Products/Bank-Product-Load module customised by Asiamah */
   public function AOS_Products(){
   global $current_user;

   if($_REQUEST["module"]=="AOS_Products"){
   echo "AOS_Products module Only";
  ...
  // alert('kkkk');
   ...
   $.ajax({
    type:'POST',
    url:'../gg/img/customer360/customer_sync_products.php?user_id=$current_user->id',
    //data:{client_id_c:client_id_c},
    success : function(results) {
    //$('#tab-content-2').html(results); 
    console.log(results);
