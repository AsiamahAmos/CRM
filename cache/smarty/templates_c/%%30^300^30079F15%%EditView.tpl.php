...
<?php $this->_tag_stack[] = array('minify', array()); $_block_repeat=true;smarty_block_minify($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_RELATED_PRODUCT','module' => 'Opportunities'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['related_product_c']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['related_product_c']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['related_product_c']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['related_product_c']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['related_product_c']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['aos_products_id_c']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['related_product_c']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['related_product_c']['name']; ?>
...
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"aos_products_id_c","name":"related_product_c"}}'; ?>
, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['related_product_c']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['related_product_c']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['related_product_c']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['related_product_c']['id_name']; ?>
...
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['<?php echo $this->_tpl_vars['form_name']; ?>
_<?php echo $this->_tpl_vars['fields']['related_product_c']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
<?php echo '\', 0, 100);
addToValidate(\'EditView\', \'aos_products_id_c\', \'id\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_RELATED_PRODUCT_AOS_PRODUCTS_ID','module' => 'Opportunities','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'contact_id_c\', \'id\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CUSTOMER_NAME_CONTACT_ID','module' => 'Opportunities','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'customer_name_c\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CUSTOMER_NAME','module' => 'Opportunities','for_js' => true), $this);?>
<?php echo '\' );
...
<?php echo '\' );
addToValidate(\'EditView\', \'related_product_c\', \'relate\', true,\''; ?>
