...
' title=''  tabindex='-1'      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='client_id_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CLIENT_ID','module' => 'Contacts'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php if (strlen ( $this->_tpl_vars['fields']['client_id_c_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['client_id_c_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['client_id_c_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['client_id_c_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['client_id_c_advanced']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''  tabindex='-1'      >
...
' title=''  tabindex='-1'      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='favorites_only_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_FAVORITES_FILTER','module' => 'Contacts'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
value="1" title='' tabindex="" <?php echo $this->_tpl_vars['checked']; ?>
 >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='birthdate_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_BIRTHDATE','module' => 'Contacts'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<span class="dateTime">
<?php $this->assign('date_value', $this->_tpl_vars['fields']['birthdate_advanced']['value']); ?>
<input class="date_input" autocomplete="off" type="text" name="<?php echo $this->_tpl_vars['fields']['birthdate_advanced']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['birthdate_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['date_value']; ?>
" title=''  tabindex='-1'    size="11" maxlength="10" >
    <button type="button" id="<?php echo $this->_tpl_vars['fields']['birthdate_advanced']['name']; ?>
...
Calendar.setup ({
inputField : "<?php echo $this->_tpl_vars['fields']['birthdate_advanced']['name']; ?>
",
form : "",
...
",
button : "<?php echo $this->_tpl_vars['fields']['birthdate_advanced']['name']; ?>
_trigger",
singleClick : true,
...
weekNumbers:false
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='segment_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SEGMENT','module' => 'Contacts'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php if (strlen ( $this->_tpl_vars['fields']['segment_c_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['segment_c_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['segment_c_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['segment_c_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['segment_c_advanced']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''  tabindex='-1'      >
...
<?php echo smarty_function_html_options(array('id' => 'lead_source_advanced','name' => 'lead_source_advanced[]','options' => $this->_tpl_vars['fields']['lead_source_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['lead_source_advanced']['value']), $this);?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='optinprimary_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_OPT_IN_FLAG_PRIMARY','module' => 'Contacts'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php echo smarty_function_html_options(array('id' => 'optinprimary_advanced','name' => 'optinprimary_advanced[]','options' => $this->_tpl_vars['fields']['optinprimary_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['optinprimary_advanced']['value']), $this);?>
