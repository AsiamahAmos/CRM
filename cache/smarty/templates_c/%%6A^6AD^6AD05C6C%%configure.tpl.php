<?php /* Smarty version 2.6.31, created on 2019-10-21 22:29:21
         compiled from modules/Home/Dashlets/iFrameDashlet/configure.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'modules/Home/Dashlets/iFrameDashlet/configure.tpl', 65, false),)), $this); ?>
...
<tr>
    ...
    <td>
    	<input type="text" class="text" name="url" size='20' maxlength='2000' value='<?php echo $this->_tpl_vars['url']; ?>
'>
    </td>
</tr>
<tr>
    ...
    <td>
    	<input type="text" class="text" name="height" size='20' maxlength='80' value='<?php echo $this->_tpl_vars['height']; ?>
'>
    </td>
</tr>
<tr>
