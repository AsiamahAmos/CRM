<?php /* Smarty version 2.6.31, created on 2019-10-15 19:09:38
         compiled from cache/themes/SuiteP/modules/AOS_Quotes/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/AOS_Quotes/SearchForm_advanced.tpl', 27, false),array('function', 'math', 'cache/themes/SuiteP/modules/AOS_Quotes/SearchForm_advanced.tpl', 28, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/AOS_Quotes/SearchForm_advanced.tpl', 34, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/AOS_Quotes/SearchForm_advanced.tpl', 232, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/AOS_Quotes/SearchForm_advanced.tpl', 499, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/AOS_Quotes/SearchForm_advanced.tpl', 580, false),array('modifier', 'default', 'cache/themes/SuiteP/modules/AOS_Quotes/SearchForm_advanced.tpl', 295, false),)), $this); ?>
...
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"billing_contact_id_advanced","name":"billing_contact_advanced"}}'; ?>
...
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"billing_account_id_advanced","name":"billing_account_advanced"}}'; ?>
...
<?php $this->assign('id', $this->_tpl_vars['fields']['total_amount_advanced']['name']); ?>

<?php if (isset ( $_REQUEST['total_amount_advanced_range_choice'] )): ?>
<?php $this->assign('starting_choice', $_REQUEST['total_amount_advanced_range_choice']); ?>
<?php else: ?>
...
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['total_amount_advanced']['options'],'selected' => $this->_tpl_vars['starting_choice']), $this);?>
...
' style='width:75px !important;' size='20' 
    ...
    value='<?php if (empty ( $_REQUEST['range_total_amount_advanced'] ) && ! empty ( $_REQUEST['total_amount_advanced'] )): ?><?php echo $_REQUEST['total_amount_advanced']; ?>
<?php else: ?><?php echo $_REQUEST['range_total_amount_advanced']; ?>
<?php endif; ?>' tabindex='' >
</div>
<div id="<?php echo $this->_tpl_vars['id']; ?>
...
' style='width:75px !important;' size='10' 
    ...
    value='<?php echo $_REQUEST['start_range_total_amount_advanced']; ?>
' tabindex=''>
...
' style='width:75px !important;' size='10' 
    ...
    value='<?php echo $_REQUEST['end_range_total_amount_advanced']; ?>
' tabindex=''>    
</div> 
</span>
                            </div>
...
<?php $this->assign('id', $this->_tpl_vars['fields']['expiration_advanced']['name']); ?>

<?php if (isset ( $_REQUEST['expiration_advanced_range_choice'] )): ?>
<?php $this->assign('starting_choice', $_REQUEST['expiration_advanced_range_choice']); ?>
<?php else: ?>
<?php $this->assign('starting_choice', "="); ?>
<?php endif; ?>
...
_range_change(this.value);">
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['expiration_advanced']['options'],'selected' => $this->_tpl_vars['starting_choice']), $this);?>

</select>
</div>

<div id="<?php echo $this->_tpl_vars['id']; ?>
_range_div" style="<?php if (preg_match ( '/^\[/' , $_REQUEST['range_expiration_advanced'] ) || $this->_tpl_vars['starting_choice'] == 'between'): ?>display:none<?php else: ?>display:''<?php endif; ?>;">
<input autocomplete="off" type="text" name="range_<?php echo $this->_tpl_vars['id']; ?>
" id="range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php if (empty ( $_REQUEST['range_expiration_advanced'] ) && ! empty ( $_REQUEST['expiration_advanced'] )): ?><?php echo $_REQUEST['expiration_advanced']; ?>
<?php else: ?><?php echo $_REQUEST['range_expiration_advanced']; ?>
...
" id="start_range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php echo $_REQUEST['start_range_expiration_advanced']; ?>
...
" id="end_range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php echo $_REQUEST['end_range_expiration_advanced']; ?>
