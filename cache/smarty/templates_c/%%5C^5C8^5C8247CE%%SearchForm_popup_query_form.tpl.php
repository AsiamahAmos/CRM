<?php /* Smarty version 2.6.31, created on 2019-11-04 20:24:04
         compiled from cache/themes/SuiteP/modules/EmailTemplates/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/EmailTemplates/SearchForm_popup_query_form.tpl', 27, false),array('function', 'math', 'cache/themes/SuiteP/modules/EmailTemplates/SearchForm_popup_query_form.tpl', 28, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/EmailTemplates/SearchForm_popup_query_form.tpl', 34, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/EmailTemplates/SearchForm_popup_query_form.tpl', 66, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/EmailTemplates/SearchForm_popup_query_form.tpl', 167, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/EmailTemplates/SearchForm_popup_query_form.tpl', 248, false),)), $this); ?>
...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'EmailTemplates'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''  tabindex='-1'      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='type_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'EmailTemplates'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
<?php echo smarty_function_html_options(array('id' => 'type_advanced','name' => 'type_advanced[]','options' => $this->_tpl_vars['fields']['type_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['type_advanced']['value']), $this);?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='subject_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SUBJECT','module' => 'EmailTemplates'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php if (strlen ( $this->_tpl_vars['fields']['subject_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['subject_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['subject_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['subject_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['subject_advanced']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''  tabindex='-1'      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='description_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'EmailTemplates'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
<?php echo ''; ?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'EmailTemplates'), $this);?>
</label>
                            </div>
            <div class="form-item">
