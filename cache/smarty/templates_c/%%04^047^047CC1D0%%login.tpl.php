<?php /* Smarty version 2.6.31, created on 2019-10-11 19:37:04
...
<div class="p_login">
	...
	<div style="background: #378cbe; height: 50px;width: 100%; padding-top: 2px;font-size: 16px;"> 
		
		<!-- <a href="unionsg.com"><img src="themes/default/images/company_logo.png" alt="Smiley face" height="50" width="250"> </a><center>
      <h2><b></b></h2>      
        </center> -->
	</div>
...
" autocomplete="off">
    ...
    <div class="p_login_bottom">
    		...
    		<a id="admin_options">&copy; Supercharged by UnionCRM</a>
            <a id="powered_by">&copy; Powered By UnionCRM</a>
