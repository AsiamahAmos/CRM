<?php /* Smarty version 2.6.31, created on 2019-10-29 20:26:34
         compiled from modules/DynamicFields/templates/Fields/Forms/url.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'modules/DynamicFields/templates/Fields/Forms/url.tpl', 48, false),array('function', 'html_options', 'modules/DynamicFields/templates/Fields/Forms/url.tpl', 66, false),array('modifier', 'default', 'modules/DynamicFields/templates/Fields/Forms/url.tpl', 75, false),)), $this); ?>
...
:</td>
	<td>
	<?php if ($this->_tpl_vars['hideLevel'] < 5): ?>
		<input type='text' name='len' value='<?php echo ((is_array($_tmp=@$this->_tpl_vars['vardef']['len'])) ? $this->_run_mod_handler('default', true, $_tmp, 255) : smarty_modifier_default($_tmp, 255)); ?>
...
<tr>
	<td class='mbLBL'><?php echo smarty_function_sugar_translate(array('module' => 'DynamicFields','label' => 'LBL_LINK_TARGET'), $this);?>
:</td>
	<td>
	<?php if ($this->_tpl_vars['hideLevel'] < 5): ?>
		<select name='ext4' id='ext4'>
            <?php echo $this->_tpl_vars['TARGET_OPTIONS']; ?>

        </select>
	<?php else: ?>
		<select name='extdis' id='extdis' disabled>
            <option value='<?php echo $this->_tpl_vars['LINK_TARGET']; ?>
'><?php echo $this->_tpl_vars['LINK_TARGET_LABEL']; ?>
</option>
        </select>
        <input type='hidden' name='ext4' value='<?php echo $this->_tpl_vars['LINK_TARGET']; ?>
'>
	<?php endif; ?>
	</td>
</tr>
