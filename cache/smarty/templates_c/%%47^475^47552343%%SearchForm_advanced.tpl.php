<?php /* Smarty version 2.6.31, created on 2019-10-25 21:27:12
         compiled from cache/themes/SuiteP/modules/OutboundEmailAccounts/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/OutboundEmailAccounts/SearchForm_advanced.tpl', 27, false),array('function', 'math', 'cache/themes/SuiteP/modules/OutboundEmailAccounts/SearchForm_advanced.tpl', 28, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/OutboundEmailAccounts/SearchForm_advanced.tpl', 34, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/OutboundEmailAccounts/SearchForm_advanced.tpl', 122, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/OutboundEmailAccounts/SearchForm_advanced.tpl', 139, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/OutboundEmailAccounts/SearchForm_advanced.tpl', 220, false),)), $this); ?>
...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'OutboundEmailAccounts'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''  tabindex='-1'      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='mail_smtpuser_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_USERNAME','module' => 'OutboundEmailAccounts'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php if (strlen ( $this->_tpl_vars['fields']['mail_smtpuser_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['mail_smtpuser_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['mail_smtpuser_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['mail_smtpuser_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['mail_smtpuser_advanced']['name']; ?>
' size='30' 
    maxlength='100' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''  tabindex='-1'      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='mail_smtpserver_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SMTP_SERVERNAME','module' => 'OutboundEmailAccounts'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php if (strlen ( $this->_tpl_vars['fields']['mail_smtpserver_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['mail_smtpserver_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['mail_smtpserver_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['mail_smtpserver_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['mail_smtpserver_advanced']['name']; ?>
' size='30' 
    maxlength='100' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''  tabindex='-1'      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'OutboundEmailAccounts'), $this);?>
</label>
                            </div>
            <div class="form-item">
