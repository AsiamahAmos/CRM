...
"><?php echo $this->_tpl_vars['submodulename']; ?>
                ...
                <script>
///Search question popup///////////////////////code also in include\\SearchForm\\tpls\\footerPopup.tpl because of changes in url
             var currentTab = $(\'#moduleTab_Contacts\').text();
             if(currentTab==\'Contacts\'){
              $(\'#contacts\').append(\'<li onclick="search();" class="actionmenulinks" role="presentation"><a href="javascript:void(0)"><div class="side-bar-action-icon"><span class="suitepicon suitepicon-action-search"></span></div><div class="actionmenulink">Quick Search</div></a></li>\');
          }
 //alert(\'ejghdf\');
 ///////Customer 360 Search modal /////////
 function customer360(){
   //$(\'#customerID\').focus();
   // $(\'#customer360\').modal(\'toggle\');
   $(\'#customer360\').modal(\'toggle\');
   // alert("hi");               
 };
 ///////////////////////////////////////////   
 ///////Fetch All customer 360 list View Data///////////////code also in contacts
...
$(\'#ajaz_load_body\').html(\'<center><div class="loader"><img src="../crm/themes/suiteP/images/loading.gif" style="width:80px"/></div></center>\');
...
///////////////////End Of Customer 360 List View Data///////
///////////////////End of the sidebar search button//////////////////////////////////
         //alert(currentTab);
function search(){
    $(\'#sea\').modal(\'toggle\');
            };
...
function birthday(){// function to post birthday data 
/////////Ajax code for birthday subscribed///////
            $.ajax({

             type:"POST",
             url:"http://192.168.1.195/gg/img/customer360/birthday-in-this-month.php",
            //data:{client_id_c:client_id_c},
            success : function(results) {
            $(\'#head\').html(\'Contacts With Birthdate In This Month\');   
            $(\'#tabb\').html(results);
...
////////////////End of birthday function////////////////////////////////////

    function no_sms(){// function to post no sms data 
/////////Ajax code for birthday subscribed///////
            $.ajax({

             type:"POST",
             url:"http://192.168.1.195/gg/img/customer360/no-service.php",
            //data:{client_id_c:client_id_c},
            success : function(results) {
            $(\'#head\').html(\'Contacts with no SMS subscription\');    
            $(\'#tabb\').html(results);
            //location.reload();
                 }
                }) ;
