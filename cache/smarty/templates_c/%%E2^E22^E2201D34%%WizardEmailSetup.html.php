<?php /* Smarty version 2.6.31, created on 2018-11-01 12:58:53
         compiled from modules/Campaigns/WizardEmailSetup.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getimagepath', 'modules/Campaigns/WizardEmailSetup.html', 183, false),array('function', 'sugar_getscript', 'modules/Campaigns/WizardEmailSetup.html', 320, false),)), $this); ?>
<!--
/**
 *
...
<div id=wizard class="wizard-unique-elem">
	...
	<tr>
	<th colspan="2" align="left" ><h4 class="header-4"><?php echo $this->_tpl_vars['MOD']['LBL_NAVIGATION_MENU_SETUP']; ?>
</h4></th>
	</tr>
	<tr>
	<td scope="row"><span sugar='slot1'>
	<?php echo $this->_tpl_vars['EMAILSETUP']; ?>
<?php echo $this->_tpl_vars['MOD']['LBL_EMAIL_SETUP_DESC']; ?>
...
"  name="wiz_step1_mail_smtpserver"  id='mail_smtpserver'  tabindex="1" size="25" maxlength="255" value="<?php echo $this->_tpl_vars['mail_smtpserver']; ?>
"></td>
...
' size="25" maxlength="255" value="<?php echo $this->_tpl_vars['mail_smtpuser']; ?>
" tabindex='1' ></td>
...
" name="wiz_step1_mail_smtppass" id='mail_smtppass' size="25" maxlength="255" value="<?php echo $this->_tpl_vars['mail_smtppass']; ?>
" tabindex='1'></td>
															</tr>
														</table>
													</div>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr><td>&nbsp;</td></tr>
				<tr><td>&nbsp;</td></tr>
				<tr><td><h4 class="header-4"><?php echo $this->_tpl_vars['MOD']['LBL_MASS_MAILING_TITLE']; ?>
</h4></td></tr>
			<tr><td>
			 <table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
...
';
				...
				radiobutton.form[\'wiz_step1_massemailer_tracking_entities_location\'].value=\''; ?>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td valign="top" scope="row" width="20%" NOWRAP>
				<span><?php echo $this->_tpl_vars['MOD']['LBL_MAILBOX_NAME']; ?>
 <span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span>&nbsp;</span></td>
			<td valign="top"  width="30%">
				<span><input id='name' name='wiz_step2_name' title='<?php echo $this->_tpl_vars['MOD']['LBL_MAILBOX_NAME']; ?>
' tabindex='10' size='30' maxlength='255' type="text" value="" ></span></td>
			<td valign="top" scope="row" width="20%" NOWRAP>
				<span><?php echo $this->_tpl_vars['MOD']['LBL_FROM_ADDR']; ?>
:&nbsp;</span></td>
			<td valign="top"  width="30%" NOWRAP>
				<span><input name="wiz_step2_from_addr" id="from_addr" title='<?php echo $this->_tpl_vars['MOD']['LBL_FROM_ADDR']; ?>
' size='30'>&nbsp;</span></td>

		</tr>
		<tr>
			<td valign="top" scope="row">
					<span><?php echo $this->_tpl_vars['MOD']['LBL_SERVER_URL']; ?>
: <span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span>&nbsp;</span></td>
			<td valign="top"  width="30%">
				<span><input title='<?php echo $this->_tpl_vars['MOD']['LBL_SERVER_URL']; ?>
' name='wiz_step2_server_url' id='server_url' tabindex='20' size='30' maxlength='100' type="text" value="" ></span></td>
			<td valign="top" scope="row">
				<span><?php echo $this->_tpl_vars['MOD']['LBL_LOGIN']; ?>
:
				<span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span>&nbsp;</span></td>
			<td valign="top"  width="30%">
				<span><input title="<?php echo $this->_tpl_vars['MOD']['LBL_LOGIN']; ?>
" name='wiz_step2_email_user' id='email_user' tabindex='70' size='30' maxlength='100' type="text" value="" ></span></td>
		</tr>
		<tr>
			<td valign="top" scope="row" width="20%" NOWRAP>
				<span><?php echo $this->_tpl_vars['MOD']['LBL_SERVER_TYPE']; ?>
:
				<span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span>&nbsp;</span></td>
			<td valign="top"  width="30%">
...
' name='wiz_step2_protocol' id='protocol' tabindex='30' onchange="toggle_monitored_folder(this); setPortDefault();" ><?php echo $this->_tpl_vars['PROTOCOL']; ?>
			...
			<td valign="top" scope="row">
				<span><?php echo $this->_tpl_vars['MOD']['LBL_PASSWORD']; ?>
:
				<span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
&nbsp;</span></td>
			<td valign="top"  width="30%">
				<span><input id='email_password' title="<?php echo $this->_tpl_vars['MOD']['LBL_PASSWORD']; ?>
...
></span></span></td>
		...
		<tr>
			<td valign="top" scope="row" width="20%" NOWRAP>
				<span><?php echo $this->_tpl_vars['MOD']['LBL_PORT']; ?>
:
				<span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span>&nbsp;</span></td>
			<td valign="top"  width="30%">
...
" size='10'>
            <td valign="top" scope="row" width="20%" NOWRAP>
                <span><div id='label_inbox' style="<?php echo $this->_tpl_vars['DISPLAY']; ?>
"><?php echo $this->_tpl_vars['MOD']['LBL_MAILBOX']; ?>
: <span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</div></span>&nbsp;</span></td>
            <td valign="top"  width="30%">
                <span><div id='inbox' style="<?php echo $this->_tpl_vars['DISPLAY']; ?>
...
"></div>
        ...
        <tr>
            <td valign="top" scope="row" width="1%" NOWRAP>
                <div class="maybe">
                    <span><?php echo $this->_tpl_vars['MOD']['LBL_SSL']; ?>
:&nbsp;</span>
                </div>
            </td>
