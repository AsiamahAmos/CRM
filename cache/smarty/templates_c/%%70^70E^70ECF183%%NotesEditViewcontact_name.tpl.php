<?php /* Smarty version 2.6.31, created on 2019-10-15 01:15:43
         compiled from cache/include/InlineEditing/NotesEditViewcontact_name.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'cache/include/InlineEditing/NotesEditViewcontact_name.tpl', 7, false),)), $this); ?>

<input type="text" name="<?php echo $this->_tpl_vars['fields']['contact_name']['name']; ?>
" class="sqsEnabled" tabindex="1" id="<?php echo $this->_tpl_vars['fields']['contact_name']['name']; ?>
...
"<?php echo ',"name":'; ?>
"<?php echo $this->_tpl_vars['fields']['contact_name']['name']; ?>
"<?php echo '}}'; ?>
, 
	"single", 
	true
