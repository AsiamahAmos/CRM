<?php /* Smarty version 2.6.31, created on 2019-10-25 22:01:33
         compiled from cache/themes/SuiteP/modules/AOS_Products/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/AOS_Products/SearchForm_advanced.tpl', 27, false),array('function', 'math', 'cache/themes/SuiteP/modules/AOS_Products/SearchForm_advanced.tpl', 28, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/AOS_Products/SearchForm_advanced.tpl', 34, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/AOS_Products/SearchForm_advanced.tpl', 182, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/AOS_Products/SearchForm_advanced.tpl', 363, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/AOS_Products/SearchForm_advanced.tpl', 444, false),)), $this); ?>
...
<?php $this->assign('id', $this->_tpl_vars['fields']['cost_advanced']['name']); ?>

<?php if (isset ( $_REQUEST['cost_advanced_range_choice'] )): ?>
<?php $this->assign('starting_choice', $_REQUEST['cost_advanced_range_choice']); ?>
<?php else: ?>
...
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['cost_advanced']['options'],'selected' => $this->_tpl_vars['starting_choice']), $this);?>
...
' style='width:75px !important;' size='20' 
    ...
    value='<?php if (empty ( $_REQUEST['range_cost_advanced'] ) && ! empty ( $_REQUEST['cost_advanced'] )): ?><?php echo $_REQUEST['cost_advanced']; ?>
<?php else: ?><?php echo $_REQUEST['range_cost_advanced']; ?>
<?php endif; ?>' tabindex='' >
</div>
<div id="<?php echo $this->_tpl_vars['id']; ?>
...
<?php $this->assign('id', $this->_tpl_vars['fields']['price_advanced']['name']); ?>

<?php if (isset ( $_REQUEST['price_advanced_range_choice'] )): ?>
<?php $this->assign('starting_choice', $_REQUEST['price_advanced_range_choice']); ?>
<?php else: ?>
<?php $this->assign('starting_choice', "="); ?>
<?php endif; ?>
...
_range_choice" style="width:190px !important;" onchange="<?php echo $this->_tpl_vars['id']; ?>
_range_change(this.value);">
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['price_advanced']['options'],'selected' => $this->_tpl_vars['starting_choice']), $this);?>
...
' style='width:75px !important;' size='20' 
    ...
    value='<?php if (empty ( $_REQUEST['range_price_advanced'] ) && ! empty ( $_REQUEST['price_advanced'] )): ?><?php echo $_REQUEST['price_advanced']; ?>
<?php else: ?><?php echo $_REQUEST['range_price_advanced']; ?>
<?php endif; ?>' tabindex='' >
</div>
<div id="<?php echo $this->_tpl_vars['id']; ?>
_between_range_div" style="<?php if ($this->_tpl_vars['starting_choice'] == 'between'): ?>display:'';<?php else: ?>display:none;<?php endif; ?>">
