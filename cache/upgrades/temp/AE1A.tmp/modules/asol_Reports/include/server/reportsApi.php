...
switch ($actionTarget) {
	...
	case "edit_report":
		...
		$returnResult = asol_ControllerReportEdit::display($actionValue, true, true);
		break;
	...
	case "get_edit_report":
		header('Content-Type: application/json');
		$returnResult = asol_ControllerReports::getEditReport($actionValue);
		break;
		
	case "save_report":
		$returnResult = asol_ControllerReports::saveReport($actionValue);
		break;
