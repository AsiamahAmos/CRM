...
while ($archivo = readdir($directorio)) {
	...
	if ((filemtime($tmpFilesDir.$archivo) < $aWeek) && ( endsWith(strtolower($archivo), ".xml") || endsWith(strtolower($archivo), ".js") || endsWith(strtolower($archivo), ".html") || endsWith(strtolower($archivo), ".zip") || endsWith(strtolower($archivo), ".pdf") || endsWith(strtolower($archivo), ".png") || endsWith(strtolower($archivo), ".txt") || endsWith(strtolower($archivo), ".php")|| endsWith(strtolower($archivo), ".csv") || endsWith(strtolower($archivo), ".xls") ))
...
while ($archivo = readdir($directorio)) {
	...
	if ((filemtime($tmpFilesDir.$tmpStoredDir.$archivo) < $aWeek) && ( endsWith(strtolower($archivo), ".xml") || endsWith(strtolower($archivo), ".js") || endsWith(strtolower($archivo), ".txt") || endsWith(strtolower($archivo), ".php")))
