...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'>{sugar_translate label='LBL_NAME' module='Surveys'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    value='{$value}' title=''  tabindex='-1'      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='Surveys'}</label>
                            </div>
            <div class="form-item">
