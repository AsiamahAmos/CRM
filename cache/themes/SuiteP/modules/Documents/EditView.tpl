...
<script type="text/javascript" src='cache/include/externalAPI.cache.js?v=6WLhuBDKYlGzTB3bWJDnpQ'></script>
<script type="text/javascript" src='include/SugarFields/Fields/File/SugarFieldFile.js?v=6WLhuBDKYlGzTB3bWJDnpQ'></script>
...
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.subcategory_id.name}-input', '{$fields.subcategory_id.name}');sync_{$fields.subcategory_id.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
