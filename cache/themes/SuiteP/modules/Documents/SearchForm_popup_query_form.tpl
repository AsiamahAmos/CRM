...
<input class="date_input" autocomplete="off" type="text" name="{$fields.active_date_advanced.name}" id="{$fields.active_date_advanced.name}" value="{$date_value}" title=''  tabindex='-1'    size="11" maxlength="10" >
...
<input class="date_input" autocomplete="off" type="text" name="{$fields.exp_date_advanced.name}" id="{$fields.exp_date_advanced.name}" value="{$date_value}" title=''  tabindex='-1'    size="11" maxlength="10" >
