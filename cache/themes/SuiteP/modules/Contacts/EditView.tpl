...
{/if}  
<input type='text' name='{$fields.other_names_c.name}' 
id='{$fields.other_names_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{/if}  
<input type='text' name='{$fields.tax_id_c.name}' 
id='{$fields.tax_id_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
<input class="date_input" autocomplete="off" type="text" name="{$fields.client_since_c.name}" id="{$fields.client_since_c.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
<button type="button" id="{$fields.client_since_c.name}_trigger" class="btn btn-danger" onclick="return false;"><span class="suitepicon suitepicon-module-calendar" alt="{$APP.LBL_ENTER_DATE}"></span></button>
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.client_since_c.name}",
form : "EditView",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.client_since_c.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
...
<input type="text" name="{$fields.branch_c.name}" class="sqsEnabled" tabindex="0" id="{$fields.branch_c.name}" size="" value="{$fields.branch_c.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.branch_c.id_name}" 
id="{$fields.branch_c.id_name}" 
value="{$fields.bran_branches_id_c.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.branch_c.name}" id="btn_{$fields.branch_c.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"bran_branches_id_c","name":"branch_c"}}{/literal}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.branch_c.name}" id="btn_clr_{$fields.branch_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.branch_c.name}', '{$fields.branch_c.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.branch_c.name}']) != 'undefined'",
		enableQS
);
</script>
</div>
...
{/if}  
<input type='text' name='{$fields.employer_c.name}' 
id='{$fields.employer_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{/if}  
<input type='text' name='{$fields.primary_id_number_c.name}' 
id='{$fields.primary_id_number_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{/if}  
<input type='text' name='{$fields.primary_id_type_c.name}' 
id='{$fields.primary_id_type_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{/if}  
<input type='text' name='{$fields.mother_maiden_name_c.name}' 
id='{$fields.mother_maiden_name_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{/if}  
<input type='text' name='{$fields.occupation_c.name}' 
id='{$fields.occupation_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{/if}  
<input type='text' name='{$fields.line_of_business_c.name}' 
id='{$fields.line_of_business_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{/if}  
<input type='text' name='{$fields.spouse_c.name}' 
id='{$fields.spouse_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{/if}  
<input type='text' name='{$fields.hobby_c.name}' 
id='{$fields.hobby_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{/if}  
<input type='text' name='{$fields.interest_area_c.name}' 
id='{$fields.interest_area_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
addToValidate('EditView', 'birth_month_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_BIRTH_MONTH' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'branch_c', 'relate', true,'{/literal}{sugar_translate label='LBL_BRANCH' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'bran_branches_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_BRANCH_BRAN_BRANCHES_ID' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'client_id_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CLIENT_ID' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'client_since_c', 'date', false,'{/literal}{sugar_translate label='LBL_CLIENT_SINCE' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'current_balance_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CURRENT_BALANCE' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'customer_type_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CUSTOMER_TYPE' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'employer_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_EMPLOYER' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'gender_c', 'enum', true,'{/literal}{sugar_translate label='LBL_GENDER' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'hobby_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_HOBBY' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'interest_area_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_INTEREST_AREA' module='Contacts' for_js=true}{literal}' );
...
addToValidate('EditView', 'last_credited_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_LAST_CREDITED' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'last_debited_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_LAST_DEBITED' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'line_of_business_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_LINE_OF_BUSINESS' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'mother_maiden_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_MOTHER_MAIDEN_NAME' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'occupation_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_OCCUPATION' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'open_balance_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_OPEN_BALANCE' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'other_names_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_OTHER_NAMES' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'primary_id_number_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_PRIMARY_ID_NUMBER' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'primary_id_type_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_PRIMARY_ID_TYPE' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'relation_officer_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_RELATION_OFFICER' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'rm_code_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_RM_CODE' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'segment_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SEGMENT' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'spouse_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SPOUSE' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'tax_id_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_TAX_ID' module='Contacts' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'branch_c', 'alpha', true,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Contacts' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_BRANCH' module='Contacts' for_js=true}{literal}', 'bran_branches_id_c' );
