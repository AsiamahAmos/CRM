...
<input type='text' name='{$fields.last_name_advanced.name}' 
    ...
    value='{$value}' title=''  tabindex='-1'      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='client_id_c_advanced'>{sugar_translate label='LBL_CLIENT_ID' module='Contacts'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.client_id_c_advanced.value) <= 0}
{assign var="value" value=$fields.client_id_c_advanced.default_value }
{else}
{assign var="value" value=$fields.client_id_c_advanced.value }
{/if}  
<input type='text' name='{$fields.client_id_c_advanced.name}' 
    id='{$fields.client_id_c_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''  tabindex='-1'      >
                            </div>
        </div>
...
<input class="date_input" autocomplete="off" type="text" name="{$fields.birthdate_advanced.name}" id="{$fields.birthdate_advanced.name}" value="{$date_value}" title=''  tabindex='-1'    size="11" maxlength="10" >
    <button type="button" id="{$fields.birthdate_advanced.name}_trigger" class="btn btn-danger" onclick="return false;"><span class="suitepicon suitepicon-module-calendar" alt="{$APP.LBL_ENTER_DATE}"></span></button>
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.birthdate_advanced.name}",
form : "",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.birthdate_advanced.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
...
{rdelim}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='segment_c_advanced'>{sugar_translate label='LBL_SEGMENT' module='Contacts'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.segment_c_advanced.value) <= 0}
{assign var="value" value=$fields.segment_c_advanced.default_value }
{else}
{assign var="value" value=$fields.segment_c_advanced.value }
{/if}  
<input type='text' name='{$fields.segment_c_advanced.name}' 
    id='{$fields.segment_c_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''  tabindex='-1'      >
                            </div>
        </div>
...
{html_options id='lead_source_advanced' name='lead_source_advanced[]' options=$fields.lead_source_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.lead_source_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='optinprimary_advanced'>{sugar_translate label='LBL_OPT_IN_FLAG_PRIMARY' module='Contacts'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='optinprimary_advanced' name='optinprimary_advanced[]' options=$fields.optinprimary_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.optinprimary_advanced.value}
                            </div>
        </div>
    </div>
