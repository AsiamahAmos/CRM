...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_PRIMARY_ADDRESS_STREET' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_ALT_ADDRESS_STREET' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"form_QuickCreate_Contacts","field_to_name_array":{"id":"reports_to_id","last_name":"report_to_name"}}{/literal}, 
"single", 
true
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"form_QuickCreate_Contacts","field_to_name_array":{"id":"campaign_id","name":"campaign_name"}}{/literal}, 
"single", 
true
...
addToValidate('form_QuickCreate_Contacts', 'birth_month_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_BIRTH_MONTH' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'branch_c', 'relate', true,'{/literal}{sugar_translate label='LBL_BRANCH' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'bran_branches_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_BRANCH_BRAN_BRANCHES_ID' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'client_id_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CLIENT_ID' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'client_since_c', 'date', false,'{/literal}{sugar_translate label='LBL_CLIENT_SINCE' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'current_balance_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CURRENT_BALANCE' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'customer_type_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CUSTOMER_TYPE' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'employer_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_EMPLOYER' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'gender_c', 'enum', true,'{/literal}{sugar_translate label='LBL_GENDER' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'hobby_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_HOBBY' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'interest_area_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_INTEREST_AREA' module='Contacts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Contacts', 'last_credited_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_LAST_CREDITED' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'last_debited_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_LAST_DEBITED' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'line_of_business_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_LINE_OF_BUSINESS' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'mother_maiden_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_MOTHER_MAIDEN_NAME' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'occupation_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_OCCUPATION' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'open_balance_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_OPEN_BALANCE' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'other_names_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_OTHER_NAMES' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'primary_id_number_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_PRIMARY_ID_NUMBER' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'primary_id_type_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_PRIMARY_ID_TYPE' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'relation_officer_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_RELATION_OFFICER' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'rm_code_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_RM_CODE' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'segment_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SEGMENT' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'spouse_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SPOUSE' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'tax_id_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_TAX_ID' module='Contacts' for_js=true}{literal}' );
...
addToValidateBinaryDependency('form_QuickCreate_Contacts', 'report_to_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Contacts' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_REPORTS_TO' module='Contacts' for_js=true}{literal}', 'reports_to_id' );
addToValidateBinaryDependency('form_QuickCreate_Contacts', 'campaign_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Contacts' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_CAMPAIGN' module='Contacts' for_js=true}{literal}', 'campaign_id' );
