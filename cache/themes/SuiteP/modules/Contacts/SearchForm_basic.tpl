...
<input type='text' name='{$fields.search_name_basic.name}' 
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='client_id_c_basic' >{sugar_translate label='LBL_CLIENT_ID' module='Contacts'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
{if strlen($fields.client_id_c_basic.value) <= 0}
{assign var="value" value=$fields.client_id_c_basic.default_value }
{else}
{assign var="value" value=$fields.client_id_c_basic.value }
{/if}  
<input type='text' name='{$fields.client_id_c_basic.name}' 
    id='{$fields.client_id_c_basic.name}' size='30' 
    maxlength='255' 
