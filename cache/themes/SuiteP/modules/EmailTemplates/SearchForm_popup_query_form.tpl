...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'>{sugar_translate label='LBL_NAME' module='EmailTemplates'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    value='{$value}' title=''  tabindex='-1'      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='type_advanced'>{sugar_translate label='LBL_TYPE' module='EmailTemplates'}</label>
                            </div>
            <div class="form-item">
...
{html_options id='type_advanced' name='type_advanced[]' options=$fields.type_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.type_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='subject_advanced'>{sugar_translate label='LBL_SUBJECT' module='EmailTemplates'}</label>
                            </div>
            <div class="form-item">
...
{/if}  
<input type='text' name='{$fields.subject_advanced.name}' 
    id='{$fields.subject_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''  tabindex='-1'      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='description_advanced'>{sugar_translate label='LBL_DESCRIPTION' module='EmailTemplates'}</label>
                            </div>
            <div class="form-item">
...
{literal}{/literal}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='EmailTemplates'}</label>
                            </div>
            <div class="form-item">
