...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"aos_products_id_c","name":"related_product_c"}}{/literal}, 
"single", 
true
...
addToValidate('EditView', 'aos_products_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_RELATED_PRODUCT_AOS_PRODUCTS_ID' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'contact_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_CUSTOMER_NAME_CONTACT_ID' module='Opportunities' for_js=true}{literal}' );
addToValidate('EditView', 'customer_name_c', 'relate', false,'{/literal}{sugar_translate label='LBL_CUSTOMER_NAME' module='Opportunities' for_js=true}{literal}' );
...
addToValidate('EditView', 'related_product_c', 'relate', true,'{/literal}{sugar_translate label='LBL_RELATED_PRODUCT' module='Opportunities' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'related_product_c', 'alpha', true,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Opportunities' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_RELATED_PRODUCT' module='Opportunities' for_js=true}{literal}', 'aos_products_id_c' );
