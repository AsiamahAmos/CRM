...
{if !$fields.related_product_c.hidden}
{counter name="panelFieldCount" print=false}
...
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="aos_products_id_c" class="sugar_field" data-id-value="{$fields.aos_products_id_c.value}">{$fields.related_product_c.value}</span>
