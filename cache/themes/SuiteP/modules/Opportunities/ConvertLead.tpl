...
scope="row" class="col-xs-12 col-sm-12 label" >
{capture name="label" assign="label"}
{sugar_translate label='LBL_RELATED_PRODUCT' module='Opportunities'}
{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</div>
...
<input type="text" name="Opportunitiesrelated_product_c" class="sqsEnabled" tabindex="0" id="Opportunitiesrelated_product_c" size="" value="{$fields.related_product_c.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="Opportunities{$fields.related_product_c.id_name}" 
id="Opportunities{$fields.related_product_c.id_name}" 
value="{$fields.aos_products_id_c.value}">
<span class="id-ff multiple">
<button type="button" name="btn_Opportunitiesrelated_product_c" id="btn_Opportunitiesrelated_product_c" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"ConvertLead","field_to_name_array":{"id":"Opportunitiesaos_products_id_c","name":"Opportunitiesrelated_product_c"}}{/literal}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_Opportunitiesrelated_product_c" id="btn_clr_Opportunitiesrelated_product_c" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, 'Opportunitiesrelated_product_c', 'Opportunitiesrelated_product_c_{$fields.related_product_c.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_Opportunitiesrelated_product_c']) != 'undefined'",
		enableQS
);
</script>
</div>
...
addToValidateBinaryDependency('ConvertLead', 'related_product_c', 'alpha', true,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Opportunities' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_RELATED_PRODUCT' module='Opportunities' for_js=true}{literal}', 'aos_products_id_c' );
</script><script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['ConvertLead_Opportunitiesrelated_product_c']={"form":"ConvertLead","method":"query","modules":["AOS_Products"],"group":"or","field_list":["name","id"],"populate_list":["Opportunitiesrelated_product_c","Opportunitiesaos_products_id_c"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>{/literal}
