...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_RELATED_PRODUCT">

{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_RELATED_PRODUCT' module='Opportunities'}{/capture}
{$label|strip_semicolon}:
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="relate" field="related_product_c"  >
{counter name="panelFieldCount" print=false}

<input type="text" name="{$fields.related_product_c.name}" class="sqsEnabled" tabindex="0" id="{$fields.related_product_c.name}" size="" value="{$fields.related_product_c.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.related_product_c.id_name}" 
id="{$fields.related_product_c.id_name}" 
value="{$fields.aos_products_id_c.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.related_product_c.name}" id="btn_{$fields.related_product_c.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.related_product_c.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"form_SubpanelQuickCreate_Opportunities","field_to_name_array":{"id":"aos_products_id_c","name":"related_product_c"}}{/literal}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.related_product_c.name}" id="btn_clr_{$fields.related_product_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.related_product_c.name}', '{$fields.related_product_c.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.related_product_c.name}']) != 'undefined'",
		enableQS
);
</script>
</div>
...
addToValidate('form_SubpanelQuickCreate_Opportunities', 'aos_products_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_RELATED_PRODUCT_AOS_PRODUCTS_ID' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'contact_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_CUSTOMER_NAME_CONTACT_ID' module='Opportunities' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Opportunities', 'customer_name_c', 'relate', false,'{/literal}{sugar_translate label='LBL_CUSTOMER_NAME' module='Opportunities' for_js=true}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_Opportunities', 'related_product_c', 'relate', true,'{/literal}{sugar_translate label='LBL_RELATED_PRODUCT' module='Opportunities' for_js=true}{literal}' );
...
addToValidateBinaryDependency('form_SubpanelQuickCreate_Opportunities', 'related_product_c', 'alpha', true,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Opportunities' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_RELATED_PRODUCT' module='Opportunities' for_js=true}{literal}', 'aos_products_id_c' );
</script><script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['form_SubpanelQuickCreate_Opportunities_account_name']={"form":"form_SubpanelQuickCreate_Opportunities","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["form_SubpanelQuickCreate_Opportunities_account_name","account_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["account_id"],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects['form_SubpanelQuickCreate_Opportunities_related_product_c']={"form":"form_SubpanelQuickCreate_Opportunities","method":"query","modules":["AOS_Products"],"group":"or","field_list":["name","id"],"populate_list":["related_product_c","aos_products_id_c"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects['form_SubpanelQuickCreate_Opportunities_assigned_user_name']={"form":"form_SubpanelQuickCreate_Opportunities","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};</script>{/literal}
