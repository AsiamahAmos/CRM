...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'>{sugar_translate label='LBL_PROSPECT_LIST_NAME' module='ProspectLists'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    value='{$value}' title=''  tabindex='-1'      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='list_type_advanced'>{sugar_translate label='LBL_LIST_TYPE' module='ProspectLists'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='list_type_advanced' name='list_type_advanced[]' options=$fields.list_type_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.list_type_advanced.value}
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='current_user_only_advanced'>{sugar_translate label='LBL_CURRENT_USER_FILTER' module='ProspectLists'}</label>
                            </div>
            <div class="form-item">
