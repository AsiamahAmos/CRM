...
addToValidate('form_QuickCreate_Accounts', 'asiamah_amos_c', 'enum', false,'{/literal}{sugar_translate label='LBL_ASIAMAH_AMOS' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'facebook_user_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_FACEBOOK_USER_C' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'name_id_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_NAME_ID' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'text_field_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_TEXT_FIELD' module='Accounts' for_js=true}{literal}' );
