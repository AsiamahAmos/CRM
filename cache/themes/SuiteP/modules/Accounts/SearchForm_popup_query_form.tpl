...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    value='{$value}' title=''  tabindex='-1'      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='description_advanced'>{sugar_translate label='LBL_DESCRIPTION' module='Accounts'}</label>
                            </div>
            <div class="form-item">
...
{html_options id='industry_advanced' name='industry_advanced[]' options=$fields.industry_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.industry_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='created_by_name_advanced'>{sugar_translate label='LBL_CREATED' module='Accounts'}</label>
                            </div>
            <div class="form-item">
