...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_STAFF_ID' module='Users'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.staff_id_c.value) <= 0}
{assign var="value" value=$fields.staff_id_c.default_value }
{else}
{assign var="value" value=$fields.staff_id_c.value }
{/if}  
<input type='text' name='{$fields.staff_id_c.name}' 
id='{$fields.staff_id_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_SEGMENT' module='Users'}{/capture}
{$label|strip_semicolon}:
...
<input type="text" name="{$fields.segment_c.name}" class="sqsEnabled" tabindex="0" id="{$fields.segment_c.name}" size="" value="{$fields.segment_c.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.segment_c.id_name}" 
id="{$fields.segment_c.id_name}" 
value="{$fields.account_id_c.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.segment_c.name}" id="btn_{$fields.segment_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_SELECT_ACCOUNTS_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_ACCESSKEY_SELECT_ACCOUNTS_LABEL"}"
onclick='open_popup(
"{$fields.segment_c.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"account_id_c","name":"segment_c"}}{/literal}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.segment_c.name}" id="btn_clr_{$fields.segment_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_ACCOUNTS_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.segment_c.name}', '{$fields.segment_c.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_ACCOUNTS_LABEL"}" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.segment_c.name}']) != 'undefined'",
		enableQS
);
</script>
</div>
...
addToValidate('EditView', 'account_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_SEGMENT_ACCOUNT_ID' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'segment_c', 'relate', false,'{/literal}{sugar_translate label='LBL_SEGMENT' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'staff_id_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_STAFF_ID' module='Users' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'segment_c', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Users' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_SEGMENT' module='Users' for_js=true}{literal}', 'account_id_c' );
