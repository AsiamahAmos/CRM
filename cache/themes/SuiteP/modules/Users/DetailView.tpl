...
{/if} 
<span class="sugar_field" id="{$fields.staff_id_c.name}">{$fields.staff_id_c.value}</span>
{/if}
...
<span id="account_id_c" class="sugar_field" data-id-value="{$fields.account_id_c.value}">{$fields.segment_c.value}</span>
