...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'>{sugar_translate label='LBL_NAME' module='AOW_WorkFlow'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    value='{$value}' title=''  tabindex='-1'      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='status_advanced'>{sugar_translate label='LBL_STATUS' module='AOW_WorkFlow'}</label>
                            </div>
            <div class="form-item">
...
{html_options id='status_advanced' name='status_advanced[]' options=$fields.status_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.status_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='AOW_WorkFlow'}</label>
                            </div>
            <div class="form-item">
