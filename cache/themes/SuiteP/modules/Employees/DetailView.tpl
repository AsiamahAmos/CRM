...
{capture name="label" assign="label"}{sugar_translate label='LBL_SEGMENT' module='Employees'}{/capture}
{$label|strip_semicolon}:
</div>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_STAFF_ID' module='Employees'}{/capture}
{$label|strip_semicolon}:
</div>
