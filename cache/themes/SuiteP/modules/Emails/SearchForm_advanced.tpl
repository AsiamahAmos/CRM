...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='imap_keywords_advanced'>{sugar_translate label='LBL_IMAP_KEYWORDS' module='Emails'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.imap_keywords_advanced.value) <= 0}
{assign var="value" value=$fields.imap_keywords_advanced.default_value }
{else}
{assign var="value" value=$fields.imap_keywords_advanced.value }
{/if}  
<input type='text' name='{$fields.imap_keywords_advanced.name}' 
    id='{$fields.imap_keywords_advanced.name}' size='30' 
    ...
    value='{$value}' title=''  tabindex='-1'      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='from_addr_name_advanced'>{sugar_translate label='LBL_FROM' module='Emails'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.from_addr_name_advanced.value) <= 0}
{assign var="value" value=$fields.from_addr_name_advanced.default_value }
{else}
{assign var="value" value=$fields.from_addr_name_advanced.value }
{/if}  
<input type='text' name='{$fields.from_addr_name_advanced.name}' 
    id='{$fields.from_addr_name_advanced.name}' size='30' 
    ...
    value='{$value}' title=''  tabindex='-1'      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='to_addrs_names_advanced'>{sugar_translate label='LBL_TO' module='Emails'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.to_addrs_names_advanced.value) <= 0}
{assign var="value" value=$fields.to_addrs_names_advanced.default_value }
{else}
{assign var="value" value=$fields.to_addrs_names_advanced.value }
{/if}  
<input type='text' name='{$fields.to_addrs_names_advanced.name}' 
    id='{$fields.to_addrs_names_advanced.name}' size='30' 
    ...
    value='{$value}' title=''  tabindex='-1'      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'>{sugar_translate label='LBL_SUBJECT' module='Emails'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    value='{$value}' title=''  tabindex='-1'      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='description_advanced'>{sugar_translate label='LBL_BODY' module='Emails'}</label>
                            </div>
            <div class="form-item">
...
{literal}{/literal}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='Emails'}</label>
                            </div>
            <div class="form-item">
...
{html_options id='assigned_user_id_advanced' name='assigned_user_id_advanced[]' options=$fields.assigned_user_id_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.assigned_user_id_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='category_id_advanced'>{sugar_translate label='LBL_CATEGORY' module='Emails'}</label>
                            </div>
            <div class="form-item">
...
{html_options id='category_id_advanced' name='category_id_advanced[]' options=$fields.category_id_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.category_id_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='parent_name_advanced'>{sugar_translate label='LBL_EMAIL_RELATE' module='Emails'}</label>
                            </div>
            <div class="form-item">
