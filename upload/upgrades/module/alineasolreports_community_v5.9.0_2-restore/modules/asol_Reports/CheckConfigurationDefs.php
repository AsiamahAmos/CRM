...
echo '
<script type="text/javascript" src="modules/asol_Common/include/client/libraries/asolJquery.js?version='.str_replace('.', '', asol_CommonUtils::$common_version).'"></script>
<link type="text/css" href="modules/asol_Common/include/client/css/asolicons.css?version='.str_replace('.', '', asol_CommonUtils::$common_version).'" rel="stylesheet">
';
...
//**********************************//
	...
	echo asol_CheckConfigurationDefsFunctions::checkFileAccess("NVD3 Core CSS", "Execute_NVD3_Core_CSS", "modules/asol_Reports/include/client/libraries/nvd3/src/nv.d3.css");
	//*****************************//
	//***AlineaSol Execution CSS***//
	//*****************************//
	...
	echo asol_CheckConfigurationDefsFunctions::checkFileAccess("InnerSvg JavaScript", "Execute_InnerSvg", "modules/asol_Reports/include/client/libraries/innersvg.min.js");
	echo asol_CheckConfigurationDefsFunctions::checkFileAccess("D3 JavaScript", "Execute_D3", "modules/asol_Reports/include/client/libraries/nvd3/lib/d3.v2.min.js");
	echo asol_CheckConfigurationDefsFunctions::checkFileAccess("NVD3 Core JavaScript", "Execute_NVD3_Core", "modules/asol_Reports/include/client/libraries/nvd3/nv.d3.js");
	echo asol_CheckConfigurationDefsFunctions::checkFileAccess("NVD3 Utils JavaScript", "Execute_NVD3_Utils", "modules/asol_Reports/include/client/libraries/nvd3/src/utils.js");
	echo asol_CheckConfigurationDefsFunctions::checkFileAccess("SWFObject JavaScript", "Execute_SWFObjectFlash", "modules/asol_Reports/include/client/libraries/swfobject/swfobject.js");
	//****************************//
	//***AlineaSol Execution JS***//
	//****************************//
...
//*********************//
	...
	echo asol_CheckConfigurationDefsFunctions::checkConfiguration('asolReportsCurlRequestTimeout');
...
//***********************//
	...
	//****************************************//
	echo "<span style='font-weight: bold;'>· External database/api reports:</span></td><td width='27.5%'>";
	echo asol_CheckConfigurationDefsFunctions::checkConfiguration('asolReportsAlternativeDbConnections');
	echo asol_CheckConfigurationDefsFunctions::checkConfiguration('asolReportsExternalApiConnections');
	//****************************************//
	//***External non CRM databases reports***//
	//****************************************//
...
<script type='text/javascript'>
	asolJquery.fx.speeds._default = 500;
	asolJquery.extend(asolJquery.ui.dialog.prototype.options, { width: 500, show: 'fade', hide: 'fade'});
</script>";
